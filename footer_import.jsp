...
<script src="<%=request.getContextPath()%>/assets/global/plugins/moment.min.js" type="text/javascript"></script>
...
<script src="<%=request.getContextPath()%>/assets/global/plugins/amcharts/amcharts/amcharts.js" type="text/javasc<%=request.getContextPath()%>/kocel_common/bootstrappt"></script>
...
<script src="<%=request.getContextPath()%>/assets/global/plugins/horizontal-timeline/horozontal-timeline.min.js" type="text/javascript"></script>
...
<script src="<%=request.getContextPath()%>/assets/layouts/layout/scripts/layout.min.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/assets/layouts/layout/scripts/demo.min.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
<!-- END THEME LAYOUT SCRIPTS -->

<script src="<%=request.getContextPath()%>/portal/js/main.js" type="text/javascript"></script>